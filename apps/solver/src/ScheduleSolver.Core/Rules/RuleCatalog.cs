...
public static class RuleCatalog
{
    ...
    [
        ...
        Def("R16", "class_hour_monday_1_or_5", RuleClass.RELAXED_HARD, 60_000, EnforcementStatus.Enforced),
        Def("R17", "class_hour_teacher", RuleClass.RELAXED_HARD, 90_000, EnforcementStatus.Enforced),
        Def("R18", "class_hour_day_max_3_other_pairs", RuleClass.SOFT_STRONG, 10_000, EnforcementStatus.Enforced),
        ...
        Def("R27", "gym_two_groups_max", RuleClass.MODEL_HARD, 0, EnforcementStatus.Enforced),
        Def("R28", "gym_parallel_different_teachers", RuleClass.RELAXED_HARD, 60_000, EnforcementStatus.Enforced),
        Def("R29", "room_203_blocked_wed_thu", RuleClass.RELAXED_HARD, 50_000, EnforcementStatus.Enforced),
        Def("R30", "room_305_blocked_wed_fri", RuleClass.RELAXED_HARD, 50_000, EnforcementStatus.Enforced),
        Def("R31", "upper_lower_week_pattern", RuleClass.RELAXED_HARD, 70_000, EnforcementStatus.Enforced),
        Def("R32", "teacher_specific_days", RuleClass.RELAXED_HARD, 80_000, EnforcementStatus.Enforced),
