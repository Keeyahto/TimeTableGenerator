...
public static class RuleCatalog
{
    ...
    [
        ...
        Def("R01", "LESSON_STATE_VALID", RuleClass.MODEL_HARD, 0, EnforcementStatus.Stub),
        Def("R02", "SLOT_VALID", RuleClass.MODEL_HARD, 0, EnforcementStatus.Stub),
        Def("R03", "GROUP_NO_OVERLAP", RuleClass.MODEL_HARD, 0, EnforcementStatus.Stub),
        Def("R04", "TEACHER_NO_OVERLAP", RuleClass.MODEL_HARD, 0, EnforcementStatus.Stub),
        Def("R05", "ROOM_NO_OVERLAP", RuleClass.MODEL_HARD, 0, EnforcementStatus.Stub),
        Def("R06", "ACTIVE_WEEKS_SATURDAY", RuleClass.MODEL_HARD, 0, EnforcementStatus.Stub),
        Def("R07", "UNSCHEDULED_PENALTY", RuleClass.RELAXED_HARD, 1000, EnforcementStatus.Stub),
        Def("R08", "VIRTUAL_TEACHER", RuleClass.RELAXED_HARD, 500, EnforcementStatus.Stub),
        Def("R09", "VIRTUAL_ROOM", RuleClass.RELAXED_HARD, 500, EnforcementStatus.Stub),
