...
public static class RuleCatalog
{
    ...
    [
        ...
        Def("R11", "teacher_thu_1_meeting", RuleClass.RELAXED_HARD, 90_000, EnforcementStatus.Stub),
        Def("R12", "first_course_first_shift", RuleClass.RELAXED_HARD, 80_000, EnforcementStatus.Stub),
        Def("R13", "graduation_first_shift", RuleClass.RELAXED_HARD, 80_000, EnforcementStatus.Stub),
        Def("R14", "first_course_no_saturday", RuleClass.RELAXED_HARD, 70_000, EnforcementStatus.Stub),
        ...
        Def("R20", "group_no_gaps", RuleClass.SOFT_STRONG, 20_000, EnforcementStatus.Stub),
        Def("R21", "teacher_no_gaps", RuleClass.SOFT_MEDIUM, 1_000, EnforcementStatus.Stub),
        Def("R22", "admin_no_saturday", RuleClass.RELAXED_HARD, 50_000, EnforcementStatus.Stub),
